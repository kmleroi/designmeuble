...
<div class="wrapper ">
    ...
    <?php echo $__env->make('includes.admin-nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div class="panel-header">
            <div class="header text-center">
                <h2 class="title"><?php echo $__env->yieldContent('sectionTitle'); ?></h2>
                <p class="category"><?php echo $__env->yieldContent('sectionDesc'); ?></p>
            </div>
        </div>
        <div class="content">
