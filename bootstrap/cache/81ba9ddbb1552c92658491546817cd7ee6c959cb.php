                        ...
                        <ul>
                            ...
                            <?php if(count($rubrics)): ?>
                                <?php $__currentLoopData = $rubrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="megamenu"><a href="#"><?php echo e($rub->name); ?></a>
                                        <?php if(count($rub->categories)): ?>
                                            <ul>
                                                <?php $__currentLoopData = $rub->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <ul>
                                                            <li><?php echo e($cat->name); ?></li>
                                                            <?php if(count($rub->subCategories)): ?>
                                                                <?php $__currentLoopData = $rub->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($sub->category_id == $cat->id): ?>
                                                                        <li><a href="#"><?php echo e($sub->name); ?></a></li>
                                                                    <?php endif; ?>
